...
import { numericConstants } from 'src/constants/numeric.constant';
...
import { statusCodes } from 'src/constants/statusCode.constants';
  ...
  async addNewObject(
    ...
    if (isDataAlreadyPresent) {
      ...
      this.bucketObjectModel.create({
        bucketId: isBucketAlreadyPresent._id,
        key,
        data,
      });
    }
